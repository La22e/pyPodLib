...
For headless (non-GUI) use::
    ...
    from pypodlib.device import DeviceInfo, set_current_device, enrich
...
def detect_checksum_type(ipod_path: str):
    ...
    Returns a :class:`pypodlib.device.ChecksumType` enum value.
    """
            ...
            try:
                ...
                if itdb_path:
                    ...
                    if (len(itdb_data) >= 0xA0
                        ...
                        from pypodlib.itunesdb_writer.hash72 import extract_hash_info_to_dict
...
def _enrich_from_usb_vpd(info: DeviceInfo) -> None:
    ...
    Delegates to :func:`pypodlib.device.vpd_libusb.identify_via_vpd` on supported
    ...
    try:
        ...
        logger.debug("enrich: pypodlib.device.vpd_libusb not available")
        return
...
def _enrich_artwork_from_artworkdb(info: DeviceInfo) -> None:
    ...
    try:
        from pypodlib.artworkdb_writer.rgb565 import ALL_KNOWN_FORMATS, _extract_format_ids
