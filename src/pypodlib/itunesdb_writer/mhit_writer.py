...
``pypodlib.itunesdb_shared.field_defs.MHIT_FIELDS``.  This writer builds a
...
Cross-referenced against:
  ...
  - src/pypodlib/itunesdb_parser/mhit_parser.py parse_trackItem()
...
from pypodlib.itunesdb_shared.mhit_defs import MHIT_HEADER_SIZE, mhit_header_size_for_version
