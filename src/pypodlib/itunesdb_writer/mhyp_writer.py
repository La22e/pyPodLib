...
Cross-referenced against:
  - src/pypodlib/itunesdb_parser/mhyp_parser.py parse_playlist()
...
from pypodlib.itunesdb_shared.constants import MHOD_TYPE_ALBUM, MHOD_TYPE_TITLE
...
from pypodlib.itunesdb_shared.mhyp_defs import MHYP_HEADER_SIZE
from pypodlib.itunesdb_shared.playlist_kinds import (
    is_playlist_folder,
    is_podcast_playlist,
)
from pypodlib.itunesdb_shared.playlist_kinds import (
