...
Cross-referenced against:
  - src/pypodlib/itunesdb_shared/mhod_defs.py (field definitions and constants)
  - src/pypodlib/itunesdb_parser/mhod_parser.py _parse_string_mhod(), _parse_chapter_data()
...
def build_chapter_blob(
    ...
    Used by ``pypodlib.sqlitedb_writer.extras_writer`` for the ``chapter.data`` BLOB.
