...
``pypodlib.itunesdb_shared.field_defs.MHIP_FIELDS``.

Cross-referenced against:
  - src/pypodlib/itunesdb_shared/field_defs.py (single source of truth for offsets)
  - src/pypodlib/itunesdb_parser/mhip_parser.py parse_playlistItem()
...
from pypodlib.itunesdb_shared.constants import MHOD_TYPE_TITLE
from pypodlib.itunesdb_shared.field_base import write_fields, write_generic_header
from pypodlib.itunesdb_shared.mhip_defs import MHIP_HEADER_SIZE
from pypodlib.itunesdb_shared.mhod_defs import (
