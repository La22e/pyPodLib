...
def write_locations_cbk(
    ...
    if checksum_type == ChecksumType.HASHAB:
        ...
        from pypodlib.itunesdb_writer.hashab import compute_hashab
        ...
        from pypodlib.itunesdb_writer.hash58 import compute_hash58
        ...
        from pypodlib.itunesdb_writer.hash72 import (
            HashInfo,
            _hash_generate,
