...
from pypodlib.sync_progress_stages import (
...
class SyncEngine:
    ...
    def compute_plan(self, request: EngineRequest):
        ...
        from pypodlib.sync.fingerprint_diff_engine import FingerprintDiffEngine
        from pypodlib.sync.pc_library import PCLibrary
    ...
    def execute_plan(self, request: EngineRequest):
        ...
        from pypodlib.sync.contracts import SyncRequest
        from pypodlib.sync.mapping import MappingManager
        from pypodlib.sync.sync_executor import SyncExecutor
    ...
    def quick_write(self, request: EngineRequest):
        ...
        from pypodlib.sync.quick_writes import write_cached_itunesdb
