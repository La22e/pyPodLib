...
The preferred orchestration surface is :class:`pypodlib.sync.core.SyncEngine`.
...
_PHOTO_IMPORTS = {
    "PCPhotoLibrary": "PCPhotoLibrary",
    "PhotoAlbum": "PhotoAlbum",
    "PhotoDB": "PhotoDB",
    "PhotoEditState": "PhotoEditState",
    "PhotoEntry": "PhotoEntry",
    "PhotoSyncPlan": "PhotoSyncPlan",
    "apply_photo_sync_plan": "apply_photo_sync_plan",
    "build_photo_sync_plan": "build_photo_sync_plan",
    "load_photo_preview": "load_photo_preview",
    "read_photo_db": "read_photo_db",
    "scan_pc_photos": "scan_pc_photos",
}
"""Photo-planning names are resolved lazily (they require the ``artwork``
extra's Pillow dependency)."""


def __getattr__(name: str):
    if name in _PHOTO_IMPORTS:
        import importlib

        module = importlib.import_module("pypodlib.sync.photos")
        value = getattr(module, _PHOTO_IMPORTS[name])
        globals()[name] = value
        return value
