...
from pypodlib.artworkdb_writer.ithmb_codecs import (
    decode_pixels_for_format,
    encode_image_for_format,
    expected_size_bytes,
)
from pypodlib.device import ITHMB_FORMAT_MAP, photo_formats_for_device
from pypodlib.device.capabilities import ArtworkFormat
...
from pypodlib.device.storage_safety import require_file_size_supported
from pypodlib.infrastructure.media_folders import (
    MEDIA_TYPE_PHOTO,
    MediaFolderEntry,
