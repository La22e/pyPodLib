...
from pypodlib.device.durability import durable_unlink
from pypodlib.device.filesystem_profile import FilesystemProfile
from pypodlib.device.path_safety import UnsafeDevicePathError, resolve_device_path
from pypodlib.device.write_guard import DeviceWriteGuard, DeviceWriteSafetyError
...
def read_existing_database(
    ...
    *,
    ...
    from pypodlib.itunesdb_parser.playcounts import merge_playcounts, parse_playcounts
    from pypodlib.itunesdb_shared.extraction import (
        extract_datasets,
    ...
    from pypodlib.itunesdb_shared.field_base import filetype_to_string
    ...
    from pypodlib.device import resolve_itdb_path
    ...
    try:
        ...
        from pypodlib.itunesdb_shared.device_time import (
            DeviceTimeContext,
        ...
        from pypodlib.itunesdb_parser.artwork_links import hydrate_track_artwork_refs
        ...
        from pypodlib.itunesdb_parser.otg import load_otg_playlists
...
def verify_written_database(
    ...
    *,
    ...
    from pypodlib.device.filesystem import detect_filesystem_type
...
def write_database(
    ...
    if (capabilities and capabilities.uses_sqlite_db) or has_itlp:
        ...
        logger.info("Writing SQLite databases to iTunes Library.itlp/ "
                    ...
                    has_itlp)
        try:
            from pypodlib.sqlitedb_writer import write_sqlite_databases
            ...
            firewire_id = None
            try:
                from pypodlib.device import get_firewire_id
...
def commit_playcounts_if_needed(ipod_path: Path) -> bool:
    ...
    from pypodlib.itunesdb_parser.playcounts import parse_playcounts
